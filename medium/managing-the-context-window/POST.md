# Challenges of a Small Model

## Managing the Context Window

*Originally published at https://blog.craigdube.dev/blog/managing-the-context-window/*
...
`prompt reached 29773 tokens on iteration 25 (91% of num_ctx=32768) — overflow is silent (Ollama drops the oldest messages) `
...
- **Execute.** One fresh conversation *per planned page*, which reads the source, reads that page, writes it, and files it in the index.
